...
class Leg:
    ...
    def set_joint_pos(self, theta0, theta1, vel0=0, vel1=0, curr0=0, curr1=0):
        ...
        if self.simulate == True:
            ...
            self.m0.set_pos_setpoint(((theta0-self.home[0]))/(2*pi)*encoder2angle,0,6)  
            self.m1.set_pos_setpoint(((theta1-self.home[1]))/(2*pi)*encoder2angle,0,-6)
    ...
    def move_home(self):
        ...
        if self.simulate == True:
            ...
            self.m0.set_pos_setpoint(0,0,0)  
            self.m1.set_pos_setpoint(0,0,0)
